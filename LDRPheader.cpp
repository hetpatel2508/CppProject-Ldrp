...
void add_studentA()
{
    ...
    std::ofstream out("LDRPclassA.txt", std::ios::app);
...

{
            ...
            std::ifstream in("LDRPclassA.txt");
...
void replace_student_detailA()
{
                                ...
                                for(int i=1;i<=entry;i++)
                              {
                                ...
                                if(Selection_4==1)
                                {
                                    ...
                                    in.close();
                                    std::ofstream out("LDRPclassA.txt");
...
void add_studentB()
{
    ...
    std::ofstream out("LDRPclassB.txt", std::ios::app);
...
void student_details_allB()

{
            // Press 2: Get All Student's Details
            std::vector<LDRPPR> ltemp2;

            std::ifstream in("LDRPclassB.txt");
...
void student_details_perticularB()
{
    // Press 3: Get Particular Student's Details
    std::cout << "****************************************************************" << std::endl;
    std::cout << "*                                                              *" << std::endl;
...
void replace_student_detailB()
{
                                ...
                                for(int i=1;i<=entry;i++)
                              {
                                ...
                                if(Selection_4==1)
                                {
                                    ...
                                    in.close();
                                    std::ofstream out("LDRPclassB.txt");
...
void add_studentC()
{
    ...
    std::ofstream out("LDRPclassC.txt", std::ios::app);
...
void student_details_allC()

{
            // Press 2: Get All Student's Details
            std::vector<LDRPPR> ltemp2;

            std::ifstream in("LDRPclassC.txt");
...
void student_details_perticularC()
{
    // Press 3: Get Particular Student's Details
    std::cout << "****************************************************************" << std::endl;
    std::cout << "*                                                              *" << std::endl;
...
void replace_student_detailC()
{
                                ...
                                for(int i=1;i<=entry;i++)
                              {
                                ...
                                if(Selection_4==1)
                                {
                                    ...
                                    in.close();
                                    std::ofstream out("LDRPclassC.txt");
...
void student_details_perticularD()
{
    // Press 3: Get Particular Student's Details
    std::cout << "****************************************************************" << std::endl;
    std::cout << "*                                                              *" << std::endl;
...
void add_studentE()
{
    ...
    std::ofstream out("LDRPclassE.txt", std::ios::app);
...
void student_details_allE()

{
            // Press 2: Get All Student's Details
            std::vector<LDRPPR> ltemp2;

            std::ifstream in("LDRPclassE.txt");
...
void student_details_perticularE()
{
    // Press 3: Get Particular Student's Details
    std::cout << "****************************************************************" << std::endl;
    std::cout << "*                                                              *" << std::endl;
...
void replace_student_detailE()
{
                                ...
                                for(int i=1;i<=entry;i++)
                              {
                                ...
                                if(Selection_4==1)
                                {
                                    ...
                                    in.close();
                                    std::ofstream out("LDRPclassE.txt");
